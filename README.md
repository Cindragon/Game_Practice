...
This project is a collection of three mini-games built using the SFML library in C++. Users can select a game to play from the main menu, and their scores will be recorded accordingly.
